...
//check if the student field is blank or just spaces
if (strlen(trim($student)) !== 0){
    // if the student name is not empty or spaces get the id of the student
    ...
    // change success to true so we can continue
    $data['success'] = true;
}else{
    $data['errors'][] = 'Student name cannot be empty.';
}

// check to see if last query (student) was error-free
if($data['success']){
    //check if the course field is blank or just spaces
    if (strlen(trim($course)) !== 0){
        //if the course name is not empty or just spaces get the id of the course
        ...
        // success is true so we can continue
    }else{
        $data['success'] = false;
        $data['errors'][] = 'Course name cannot be empty.';
    }
}

// check to see if last query was error-free
if($data['success']){
